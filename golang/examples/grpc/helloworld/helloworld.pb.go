...
func (x *HelloReply) GetOut() string {
	if x != nil {
		return x.Out
	}
	return ""
...
func (x *HelloReply) GetTest() string {
	if x != nil {
		return x.Test
	}
	return ""
...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6f,
	0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6f, 0x75, 0x74, 0x12, 0x12, 0x0a,
	0x04, 0x74, 0x65, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x73,
	0x74, 0x32, 0x8b, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x3e, 0x0a,
	...
	0x0a, 0x53, 0x61, 0x79, 0x47, 0x6f, 0x6f, 0x64, 0x62, 0x79, 0x65, 0x12, 0x18, 0x2e, 0x68, 0x65,
...
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.Greeter.SayGoodbye:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	1, // 3: helloworld.Greeter.SayGoodbye:output_type -> helloworld.HelloReply
